...
type Stores struct {
	...
	ShowStockLevelStatus utils.ShowStockLevelStatus `gorm:"column:show_stock_level_status; type:tinyint(4)"`
	ShowOutOfStockStatus utils.ShowOutOfStockStatus `gorm:"column:show_out_of_stock_status; type:tinyint(4)"`
	BackOrderStatus      utils.BackOrderStatus      `gorm:"column:back_order_status; type:tinyint(4)"`

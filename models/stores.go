...
type Stores struct {
	...
	StockLevelStatus utils.StockLevelStatus `gorm:"column:stock_level_status; type:tinyint(4)"`
	OutOfStockStatus utils.OutOfStockStatus `gorm:"column:out_of_stock_status; type:tinyint(4)"`

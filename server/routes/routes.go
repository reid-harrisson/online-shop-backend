...
func GroupAnalytics(server *s.Server, e *echo.Group) {
	...
	e.GET("/stock/daily", handler.ReadStockAnalyticDaily)
	e.GET("/stock/weekly", handler.ReadStockAnalyticWeekly)
	e.GET("/stock/monthly", handler.ReadStockAnalyticMonthly)
	e.GET("/stock/weekday", handler.ReadStockAnalyticWeekDay)
	e.GET("/stock/hour", handler.ReadStockAnalyticHour)
	e.GET("/stock/month", handler.ReadStockAnalyticMonth)
...
func GroupProductManagement(server *s.Server, e *echo.Group) {
	...
	e.GET("/category", handler.ReadByCategory)

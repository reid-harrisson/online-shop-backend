...
func (repository *RepositoryProductChannel) ReadByProductID(modelChannels *[]models.ProductChannelsWithName, productID uint64) error {
	return repository.DB.Table("store_product_related_channels As prodchans").

...
func (repository *RepositoryProductContent) ReadByProductID(modelContents *[]models.ProductContentsWithTitle, productID uint64) error {
	return repository.DB.Table("store_product_related_contents As prodconts").
